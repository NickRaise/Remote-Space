  ...
  return (
    showTutorial && (
      <motion.div
        ...
        className="absolute bottom-6 right-6 rounded-2xl shadow-lg border border-gray-700 p-4 w-[320px] z-50 custom-bg-1 text-white select-none pointer-events-auto"
      >
